...
public class DomainCtrl {
    ...
    private void decompressFile(Fitxer targetFile, String type, Object[] decompressionStatistic) throws DomainLayerException{
        try {
            ...
            decompressionStatistic[0] = (double) decompressionStatistic[0] + (double) decompressedFileStatistic[0];
            decompressionStatistic[1] = (double) decompressionStatistic[1] + (double) decompressedFileStatistic[1];
    ...
    public Pair<byte[], byte[]> getCompareFilesContent(String filePath, String algorithm) throws DomainLayerException{
        try {
            ...
            //stream is a temporal buffer where the compressed content is wrote
            ...
            //Get the compressed content from the stream
            byte[] compressedContentWithHeader = stream.toByteArray();

            //The compressed content contains headers, the first thing to do is get the compressed content without header
            ...
            //Returns the original content and the processed content
